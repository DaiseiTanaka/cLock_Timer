...
struct FontListView: View {
    ...
    @State private var fontList = [
        ...
        Fonts(fontName: "Digital-7 MonoItalic", customFlag: true),
        ...
        Fonts(fontName: "TaurusMonoStencilDistress", customFlag: false),
        Fonts(fontName: "TaurusMonoStencilDistress-Bold", customFlag: false),
        Fonts(fontName: "TaurusMonoStencil", customFlag: false),
        Fonts(fontName: "TaurusMonoStencil-Bold", customFlag: false),
        Fonts(fontName: "TaurusMonoOutline", customFlag: false),
        Fonts(fontName: "TaurusMonoOutline-Bold", customFlag: false),
        Fonts(fontName: "TaurusMonoDistress", customFlag: false),
        Fonts(fontName: "TaurusMonoDistress-Bold", customFlag: false),
        Fonts(fontName: "TaurusMono", customFlag: false),
        Fonts(fontName: "TaurusMono-Bold", customFlag: false),
